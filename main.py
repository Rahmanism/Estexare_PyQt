...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.mainContainerVLayout.setSizeConstraint(QLayout.SetDefaultConstraint)
        self.titleLbl = QLabel(self.centralwidget)
        self.titleLbl.setObjectName(u"titleLbl")
        sizePolicy = QSizePolicy(QSizePolicy.Preferred, QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.titleLbl.sizePolicy().hasHeightForWidth())
...
"padding: 1px 20px;")
        ...
        sizePolicy2.setHeightForWidth(self.resultLbl.sizePolicy().hasHeightForWidth())
        ...
        self.suraLbl.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)

        self.horizontalLayout.addWidget(self.suraLbl)

        self.ayeLbl = QLabel(self.frame)
        self.ayeLbl.setObjectName(u"ayeLbl")
        self.ayeLbl.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)
        ...
        self.pushButton.setMinimumSize(QSize(0, 75))
        font2 = QFont()
        font2.setPointSize(16)
        font2.setBold(False)
        self.pushButton.setFont(font2)

        self.mainContainerVLayout.addWidget(self.pushButton)
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"Estexare - \u0627\u0633\u062a\u062e\u0627\u0631\u0647", None))
        self.actionNew.setText(QCoreApplication.translate("MainWindow", u"New", None))
        self.action.setText(QCoreApplication.translate("MainWindow", u"-", None))
        self.actionQuit.setText(QCoreApplication.translate("MainWindow", u"Quit", None))
        self.actionAbout.setText(QCoreApplication.translate("MainWindow", u"About", None))
        self.titleLbl.setText(QCoreApplication.translate("MainWindow", u"Estexare - \u0627\u0633\u062a\u062e\u0627\u0631\u0647", None))
        self.resultLbl.setText(QCoreApplication.translate("MainWindow", u"TextLabel", None))
        self.descriptionLbl.setText(QCoreApplication.translate("MainWindow", u"TextLabel", None))
        self.suraLbl.setText(QCoreApplication.translate("MainWindow", u"TextLabel", None))
        self.ayeLbl.setText(QCoreApplication.translate("MainWindow", u"TextLabel", None))
        self.ayeTextLbl.setText(QCoreApplication.translate("MainWindow", u"TextLabel", None))
        self.pushButton.setText(QCoreApplication.translate("MainWindow", u"New estexare - \u0627\u0633\u062a\u062e\u0627\u0631\u0647 \u062c\u062f\u06cc\u062f", None))
